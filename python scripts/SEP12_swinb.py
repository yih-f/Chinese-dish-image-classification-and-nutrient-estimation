import torchvision
import torch
log_str="SEP12_swinb-1"
flag_relay=1
flag_multiple_gpus=False
flag_BILINEAR=False
model_str= "swinb"
img_size,weights=256,'IMAGENET1K_V1'
dropout=0.2
attention_dropout=0.1
NUM_CLASSES=241
model=torchvision.models.swin_v2_b(weights=weights,dropout=dropout,attention_dropout=attention_dropout)
